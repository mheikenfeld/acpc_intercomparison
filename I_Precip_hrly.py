...
# filename_500m['WRF_NASA']="wrfout_d03*00:00"
...
# directory_CLN_500m_5min['WRF_NASA']="/group_workspaces/jasmin2/acpc/houston_deep_convection/WRF_GISS/P3_CLN/D03"
...
# directory_POL_500m_5min['WRF_NASA']="/group_workspaces/jasmin2/acpc/houston_deep_convection/WRF_GISS/P3_POL/D03"
...
# for model in models:
#     print(model,files_CLN_500m_5min[model])
#     MV_CLN[model]=load_variable_cube[model](files_CLN_500m_5min[model],variable_names[model][new_varname])
#     MV_POL[model]=load_variable_cube[model](files_POL_500m_5min[model],variable_names[model][new_varname])
